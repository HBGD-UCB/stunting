...
# Stunting analysis
# Objective 1a
# Dataset for descriptive analyses
#-----------------------------------
...
# eligible study list
elig=as.character(ss$short_id[ss$every3mo==1])

# import eligible studies
d<-NULL 
for(i in 1:length(elig)){
  d<-bindGHAP(study=elig[i], varlist=vars, dynamicvars=dynvars, d=d) 
}


save(d, file="U:/Data/Stunting/GHAP_stunting_studies_raw.Rdata")
