...
d <- d %>% filter(agecat=="0-24 months"|  agecat=="0-24 months (no birth st.)")
...
d$agecat[d$agecat=="0-24 months (no birth st.)"] <- "0-24 months"
...
d$Nstudies <-1
d <- RMA_clean(d, outcome="ever_stunted", 
...
#Drop studies or RF without sig PAF's and at least 2 RF's
