...
include_graphics(paste0(here::here(), "/ki-longitudinal-manuscripts/figures/stunting/fig-stunt-2-prev-overall_region--allage-fe.png"))
...
### Fixed effects
```{r inc-fe, echo = FALSE}
include_graphics(paste0(here::here(), "/ki-longitudinal-manuscripts/figures/stunting/fig-stunt-2-inc-overall_region--allage-fe.png"))
...
### Random effects
```{r bar-re, echo = FALSE}
include_graphics(paste0(here::here(), "/ki-longitudinal-manuscripts/figures/stunting/fig-stunt-2-flow-overall--allage-re.png"))
#include_graphics("figure-copies/fig-stunt-2-flow-overall--allage-re.png")
```

### Fixed effects
```{r bar-fe, echo = FALSE}
include_graphics(paste0(here::here(), "/ki-longitudinal-manuscripts/figures/stunting/fig-stunt-2-flow-overall--allage-fe.png"))
